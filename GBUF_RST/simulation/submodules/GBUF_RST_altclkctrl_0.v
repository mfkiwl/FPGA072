...
module  GBUF_RST_altclkctrl_0_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		clkselect = {2{1'b0}},
		outclk = wire_sd1_outclk;
endmodule //GBUF_RST_altclkctrl_0_sub
...
module  GBUF_RST_altclkctrl_0  (
    ...
    GBUF_RST_altclkctrl_0_sub  GBUF_RST_altclkctrl_0_sub_component (
                .ena (sub_wire1),
                .inclk (sub_wire3),
                .outclk (sub_wire0));
